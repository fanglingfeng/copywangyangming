 ...
 */
package webhall.tyky.com.wangyangming.wights;
...
public class CircleTextProgressbar extends TextView {
     ...
     * 外部轮廓的颜色。
     */
    private int outLineColor = Color.BLUE;
    ...
    private void initialize(Context context, AttributeSet attributeSet) {
        ...
        outLineColor = typedArray.getColor(R.styleable.CircleTextProgressbar_out_circle_color, Color.BLACK);
        typedArray.recycle();
    }
    ...
    /**
     * 目前CircleTextProgressbar在ReletiveLayot中高度会变大，导致进度条会有一点点扁。修复方法如下： 如果你要在
     * ReletiveLayot中使用CircleTextProgressbar，就不要重写onMeasure()方法，然后在xml中指定CircleTextProgressbar
     * 的宽高就好，比如都指定为50dp，然后就没有问题啦。
     * */
    @Override
