...
import webhall.tyky.com.wangyangming.bean.JsonBean;
...
public class AddressPickerHelper {
    ...
    public void ShowPickerView(onSelectedListener listener) {// 弹出选择器
    ...
    private void showPicview(onSelectedListener listener) {
